                                      ...
                                      <div className={`px-6 py-2.5 flex items-center justify-between hover:bg-white/[0.02] transition-colors group/test ${triagingTestId === test.id ? 'bg-indigo-500/[0.05]' : ''}`}>
                                        <div className="flex items-center gap-4">
                                          ...
                                          <div className="flex items-center gap-2">
                                            ...
                                            {test.project && (
                                              <span className="px-1.5 py-0.5 rounded text-[9px] font-black bg-slate-800 text-slate-400 border border-white/5 uppercase tracking-tighter group-hover/test:text-indigo-400/80 transition-colors">
                                                {test.project}
                                              </span>
                                            )}
                                          </div>
                                              ...
                                              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                                <div className="lg:col-span-9 space-y-4">
                                                  <div className="flex items-center justify-between mb-2">
                                                    <div className="flex items-center gap-2">
                                                      <XCircle className="w-3.5 h-3.5 text-rose-500" />
                                                      <span className="text-[10px] font-black text-rose-500 uppercase tracking-widest">Error Log</span>
                                                    </div>
                                                    {test.tracePath && (
                                                      <button 
                                                  ...
                                                  <div className="p-4 rounded-2xl bg-black/40 border border-white/5 font-mono text-[11px] text-rose-300/90 leading-relaxed overflow-x-auto min-h-[160px] shadow-inner">
                                                    <p className="font-bold mb-3 border-b border-white/5 pb-2">{test.error || "No error message captured"}</p>
                                                    {test.stack && <pre className="text-slate-600 whitespace-pre-wrap mt-2 text-[10px] scrollbar-hide">{test.stack}</pre>}
                                                  </div>
                                                </div>
                                                  ...
                                                  {test.screenshotPath ? (
                                                    <div className="space-y-4">
                                                      <div className="flex items-center gap-2 mb-2">
                                                        ...
                                                        <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">Failure Preview</span>
                                                      </div>
                                                    ...
                                                    <div className="h-full rounded-2xl border border-white/5 bg-white/[0.01] flex items-center justify-center text-slate-700 font-black text-[10px] uppercase tracking-widest italic">
